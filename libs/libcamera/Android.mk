...
ifeq ($(strip $(TARGET_BOARD_PLATFORM)),sc6820i)
...
LOCAL_C_INCLUDES := \
	...
	$(TOP)/device/samsung/logan2g/libs/kernel_headers \
	$(TOP)/device/samsung/logan2g/libs/libgralloc \
	$(TOP)/device/samsung/logan2g/libs/mali/src/ump/include 
...
ifneq ($(strip $(TARGET_BOARD_PLATFORM)),sc6820i)
